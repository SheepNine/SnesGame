    ...
    class Track
    {
        ...
        public static Track Deserialize(JArray data)
        {
            ...
            foreach (JObject note in data)
            {
                ...
                if (result.notePositions.Count > 1
                    && (result.notePositions[result.notePositions.Count - 2]
                        >= result.notePositions[result.notePositions.Count - 1]))
        ...
        private void SerializeNote(JsonWriter writer, Note note)
        {
            if (note is SquareNote)
            {
                ...
                writer.WriteValue(cast.MaxLength);
                writer.WritePropertyName("period_min");
                writer.WriteValue(cast.PeriodMin);
                writer.WritePropertyName("period_max");
                writer.WriteValue(cast.PeriodMax);
                writer.WritePropertyName("period_shift");
                SerializeShiftParameters(writer, cast.PeriodShiftParameters);
                writer.WritePropertyName("volume_min");
                writer.WriteValue(cast.VolumeMin);
                writer.WritePropertyName("volume_max");
                writer.WriteValue(cast.VolumeMax);
                writer.WritePropertyName("volume_shift");
                SerializeShiftParameters(writer, cast.VolumeShiftParameters);
                writer.WriteEndObject();
            }
            else if (note is Noise)
            {
                ...
                writer.WriteStartObject();
                writer.WritePropertyName("type");
                writer.WriteValue("noise");
                writer.WritePropertyName("initial_register");
                writer.WriteValue(cast.InitialRegister);
                writer.WritePropertyName("tap_mask");
                writer.WriteValue(cast.TapMask);
                writer.WritePropertyName("max_length");
                writer.WriteValue(cast.MaxLength);
                writer.WritePropertyName("speed");
                writer.WriteValue(cast.Speed);
                writer.WriteEndObject();
            }
            else
            {
            ...
            switch ((string)data["type"])
            {
                case "square":
                    return new SquareNote((ushort)data["max_length"],
                        (byte)data["volume_min"], (byte)data["volume_max"],
                        DeserializeShiftParameters((JObject)data["volume_shift"]),
                        (ushort)data["period_min"], (ushort)data["period_max"],
                        DeserializeShiftParameters((JObject)data["period_shift"]));
                case "noise":
                    return new Noise(
        ...
        private static void SerializeShiftParameters(JsonWriter writer,
            ShiftParameters parameters)
        {
            writer.WriteStartObject();
            writer.WritePropertyName("direction");
            writer.WriteValue(parameters.Direction);
            writer.WritePropertyName("edge_behaviour");
            writer.WriteValue(parameters.EdgeBehaviour);
            writer.WritePropertyName("speed");
            writer.WriteValue(parameters.Speed);
            writer.WriteEndObject();
        }
